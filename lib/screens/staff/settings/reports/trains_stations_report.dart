...
class StaffTrainStationsReport extends StatefulWidget {
  const StaffTrainStationsReport({super.key});

  @override
  State<StaffTrainStationsReport> createState() => _StaffTrainStationsReportState();
}

class _StaffTrainStationsReportState extends State<StaffTrainStationsReport> {
  List<int> trainIDs = [];
