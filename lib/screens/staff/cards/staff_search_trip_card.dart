...
import "package:railway_system/screens/staff/book.dart";
import "package:railway_system/utils.dart";

class StaffSearchTripCard extends StatelessWidget {
  final TrainCardData trainCardData;
  final bool clickable;

  const StaffSearchTripCard({super.key, required this.trainCardData, required this.clickable});
