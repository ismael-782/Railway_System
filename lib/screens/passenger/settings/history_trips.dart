...
import "package:railway_system/screens/passenger/cards/history_trip_card.dart";
import "package:railway_system/data/booking_card_data.dart";
import "package:railway_system/models/user.dart";
import "package:railway_system/models/db.dart";

class HistoryTripsPage extends StatefulWidget {
  const HistoryTripsPage({super.key});

  @override
  State<HistoryTripsPage> createState() => _HistoryTripsPageState();
}

class _HistoryTripsPageState extends State<HistoryTripsPage> {
              ...
              child: Padding(
                ...
                child: ListView(
                  children: cardsData.map((BookingCardData bookingCardData) {
                    return Column(
                      children: [
                        HistoryTripCard(bookingCardData: bookingCardData),
